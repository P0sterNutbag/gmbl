...
@export var faction_relations := {
	...
	factions.no_faction : {factions.player : 0.0, factions.jackals : 0.0, factions.ragers : 0.0, factions.bandits : -1.0},
	factions.jackals : {factions.player : 0.0, factions.no_faction : 0.0, factions.jackals : 1.0, factions.ragers : -1.0, factions.bandits : -1.0},
	factions.ragers : {factions.player : 0.0, factions.no_faction : -1.0, factions.jackals : -1.0, factions.ragers : 1.0, factions.bandits : -1.0},
	factions.bandits : {factions.player : -1.0, factions.no_faction : -1.0, factions.jackals : -1.0, factions.ragers : -1.0, factions.bandits : 1.0}
}
